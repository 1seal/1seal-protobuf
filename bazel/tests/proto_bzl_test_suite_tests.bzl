...
load(":proto_bzl_test_suite.bzl", "create_test_name")
...
def proto_bzl_test_suite_tests(name):
    ...
    loadingtest.equals(
        ...
        create_test_name(_some_test_impl, "tests"),
    )
    ...
    loadingtest.equals(
        ...
        "another_test_name",
        "another_test_tests",
        create_test_name(_another_test, "tests"),
    )
    ...
    loadingtest.equals(
        ...
        "public_test_name",
        "public_test_tests",
        create_test_name(public_test, "tests"),
    )
    ...
    loadingtest.equals(
        ...
        "inner_test_name",
        "inner_test_tests",
        create_test_name(_inner_test, "tests"),
    )
